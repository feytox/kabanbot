...
Phase 2 is done: a Mini App for providers, models and group settings. We are dropping it because a Mini App needs a separately hosted public HTTPS site, and we don't want to run one. Phase 3 replaces it with inline buttons in Telegram itself.
