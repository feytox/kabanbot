...
- Phases 1–2 are done. Phase 3 (inline-button menus instead of the Mini App, so the bot needs no public HTTPS site) is implemented; the manual check from the roadmap is still pending.
